...
const ReceiptsList = ({ receipts, loading, onRefresh }: ReceiptsListProps) => {
  ...
  const handleDownloadPDF = async (id: number, receiptNumber: string) => {
    try {
      message.loading({ content: t('receiptsList.messages.generatingPDF'), key: 'pdf' });
      ...
      message.success({ content: t('receiptsList.messages.pdfDownloaded'), key: 'pdf' });
    } catch (error: any) {
      console.error('Error downloading PDF:', error);
      message.error({ content: t('receiptsList.messages.pdfDownloadError'), key: 'pdf' });
    }
  };
          ...
          menu={{
            items: [
              ...
              },
              {
                ...
                onClick: () => handleDownloadPDF(record.id, record.receipt_number)
              },
              {
                type: 'divider'
              },
