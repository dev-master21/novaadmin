...
import { Card, Button, Space, Select, Image, Popconfirm, message, Progress, Tag } from 'antd';
...
const VRPanoramaUploader = ({ propertyId, onUpdate }: VRPanoramaUploaderProps) => {
  ...
  const handleUpload = async () => {
    // Проверка что все 6 изображений выбраны
      ...
      <Space direction="vertical" style={{ width: '100%' }} size="large">
        ...
        <Card type="inner" title={t('vr.editor.newPanorama')}>
          <Space direction="vertical" style={{ width: '100%' }}>
            ...
            {/* Номер комнаты (для bedroom, bathroom и т.д.) */}
